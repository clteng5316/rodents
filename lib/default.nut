...
//	[ VK_F6              ] = "focus next ui object",
	...
	[ 'E' | CTRL | SHIFT ] = rename_dialog_from_child,
//	[ 'F' | CTRL         ] = "find",
	[ 'J' | CTRL         ] = "adjust",
	[ 'N' | CTRL         ] = "newfolder",
	[ 'N' | SHIFT        ] = "newfile",
	[ 'S' | CTRL         ] = select_same_extension,
	[ 'S' | ALT          ] = @() set_selection(CHECKED1),
	[ 'S' | ALT | CTRL   ] = @() set_selection(CHECKED2),
	[ 'S' | ALT | SHIFT  ] = @() set_selection(CHECKED),
	[ 'T' | CTRL         ] = @() FolderTree_toggle(path),
	[ 'T' | SHIFT        ] = @() FolderTree_only(path),
	[ 'R' | CTRL         ] = "refresh",
	[ 'V' | CTRL         ] = "paste",
	[ 'V' | CTRL | SHIFT ] = rename_dialog_from_clipboard,
	[ 'V' | SHIFT        ] = paste_into,
	[ 'W' | CTRL         ] = "close",
	[ 'X' | CTRL         ] = "cut",
	[ 'Z' | CTRL         ] = "undo",
